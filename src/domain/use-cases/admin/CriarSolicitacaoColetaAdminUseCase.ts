// domain/use-cases/admin/CriarSolicitacaoColetaAdminUseCase.ts
...
export class CriarSolicitacaoColetaAdminUseCase {
  constructor(
  ...
  async execute(data: CriarSolicitacaoColetaDTO) {
    const parsed = CriarSolicitacaoColetaDTOSchema.safeParse({
      pontoColetaId: data.pontoColetaId,
      volumeInformado: data.volumeInformado,
